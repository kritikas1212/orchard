...
export function Footer() {
  const footerLinks = {
    shop: [
      ...
      { name: 'Honey Collection', href: '/collections/honey' },
      { name: 'Ghee Collection', href: '/collections/ghee' },
      { name: 'Flour Collection', href: '/collections/flour' },
      { name: 'Combo Packs', href: '/packs' },
    ],
    company: [
